...
public static class VectorExt
{
    ...
    {
        return VectorLib.Cross(left, right);
    }
}
...
public class VectorLib
{
    ...
    public VectorLib(Vector3 vec3) { Vector3 = vec3; }
    ...
    public static implicit operator VectorLib(Vector3 vec3)
    {
        return new VectorLib(vec3);
    }

    public static VectorLib operator -(VectorLib vector, VectorLib value)
    {
    ...
    public static VectorLib operator *(VectorLib vector, double scale)
    {
    ...
    public static VectorLib operator +(VectorLib vector, double value)
    {
    ...
    public static VectorLib operator *(VectorLib vector, float scale)
    {
    ...
    public static VectorLib operator +(VectorLib vector, float value)
    {
